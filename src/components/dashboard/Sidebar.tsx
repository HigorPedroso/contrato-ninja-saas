      ...
      {isMobile ? (
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-50">
          <div className="grid grid-cols-5 gap-1 p-2">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger className="flex flex-col items-center justify-center p-2">
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuItem asChild>
                  <Link to="/dashboard/assinatura">Gerenciar Assinatura</Link>
                </DropdownMenuItem>
                {isAdmin && (
                  <DropdownMenuItem asChild>
                    <Link to="/admin">Superdashboard</Link>
                  </DropdownMenuItem>
                )}
                <DropdownMenuSeparator />
        ...
        // Desktop version - Keep existing sidebar
